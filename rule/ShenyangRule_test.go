...
func TestShenyangRule_CanChow(t *testing.T) {
	j := NewShenyangRule()
	var tests = []struct {
		hand    []model.Tile
		newTile model.Tile
...
func TestShenyangRule_CanPong(t *testing.T) {
	j := NewShenyangRule()
	var tests = []struct {
		hand    []model.Tile
		newTile model.Tile
...
func TestShenyangRule_CanConcealedKong(t *testing.T) {
	j := NewShenyangRule()
	var tests = []struct {
		hand    []model.Tile
		newTile model.Tile
...
func TestShenyangRule_CanWin(t *testing.T) {
	j := NewShenyangRule()
	var tests = []struct {
		hand    []model.Tile
...
func BenchmarkShenyangRule_CanWin_Normal(b *testing.B) {
	j := NewShenyangRule()
	var test = struct {
		hand    []model.Tile
		shown   []model.ShownTile
		...
		{2, 1}, {2, 2}, {2, 3}, {2, 7}, {2, 8}, {2, 9}, {2, 9}},
		[]model.ShownTile{{config.ExposedKong, []model.Tile{{1, 3}, {1, 3}, {1, 3}, {1, 3}}}},
		model.Tile{2, 6}, true}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkShenyangRule_CanWin_LackDoor(b *testing.B) {
	j := NewShenyangRule()
	var test = struct {
		hand    []model.Tile
		shown   []model.ShownTile
